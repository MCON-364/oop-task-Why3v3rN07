...
class TaskManagerTest {
    ...
    void testRunUpdateTaskCommand() {
        ...
        assertEquals(Priority.HIGH, registry.get("Update me").orElseThrow(()->new TaskNotFoundException("Task should still exist")).priority(),
    ...
    void testRunMultipleCommands() {
        ...
        assertEquals(Priority.MEDIUM, registry.get("Task 2").orElseThrow(()->new TaskNotFoundException("Task 2 should still exist")).priority(),
